...
module.exports = {
    ...
    execute(message) {
        ...
        .addField('*lyrics artist title', "shows lyrics to a specified song - songs and artists with more than one word in them MUST be separated with a '/' (EX: 'harry/styles as/it/was', 'SZA, 20/something', 'the/band/camino berenstein', 'queen bicycle'). unfortunately, messages in discord can only be 2000 characters or fewer, so some songs may not show up correctly.")
        .addField('*randomdog', 'fetches random dog image from: https://dog.ceo/api/breeds/image/random')
        .addField('*randomjoke', "fetches random joke from: https://sv443.net/jokeapi/v2/?ref=apilist.fun")
